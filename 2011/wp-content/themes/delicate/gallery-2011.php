...
<div id="post-<?php the_ID(); ?>" class="<?php delicate_entry_class(); ?>>">
	...
	<div class="entry-content">
        ...
        <div id="galleria">
        	...
        	<?php get_2011_thumbnails(); ?>
        </div>
        
        <p>Click the large image for full size</p>
...
<div id="blog-category-link">
	<a class="view-portfolio" href="<?php bloginfo('url'); ?>/tickets" <?php if(is_page('16')) {?> style="float:left;"<? } ?>>But Tickets NOW! &raquo;</a>
