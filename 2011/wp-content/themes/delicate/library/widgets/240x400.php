...
/*
 *
 *	Plugin Name: 240x400 Advertisement Widget
 *	Description: An advanced widget that allows you to display up to four 240x400 advertisements.
 *	Author: Matt Adams
...
add_action('widgets_init', 'advertise_240_load_widgets');

// REGISTER THE WIDGET
function advertise_240_load_widgets() {
	register_widget('Advertise_240_Widget');
}

// THIS CLASS HANDLES EVERYTHING THAT NEEDS TO BE HANDLED BY THE WIDGET
class Advertise_240_Widget extends WP_Widget {

// WIDGET SETUP
function Advertise_240_Widget() {

// WIDGET SETTINGS
$widget_ops = array('classname' => 'adverts-240', 'description' => __('An advanced widget that allows you to display up to four 240x400 advertisements.') );

// WIDGET CONTROLS
$control_ops = array('width' => 320, 'height' => 350, 'id_base' => 'adverts-240-widget');

// CREATES THE WIDGET
$this->WP_Widget('adverts-240-widget', __('240x400 Advertisements'), $widget_ops, $control_ops ); }
