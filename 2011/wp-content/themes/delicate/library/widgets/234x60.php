...
/*
 *
 *	Plugin Name: 234x60 Advertisement Widget
 *	Description: An advanced widget that allows you to display up to four 234x60 Advertisements.
 *	Author: Matt Adams
...
add_action('widgets_init', 'advertise_234_load_widgets');

// REGISTER THE WIDGET
function advertise_234_load_widgets() {
	register_widget('Advertise_234_Widget');
}

// THIS CLASS HANDLES EVERYTHING THAT NEEDS TO BE HANDLED BY THE WIDGET
class Advertise_234_Widget extends WP_Widget {

// WIDGET SETUP
function Advertise_234_Widget() {

// WIDGET SETTINGS
$widget_ops = array('classname' => 'adverts-234', 'description' => __('An advanced widget that allows you to display up to four 234x60 advertisements.') );

// WIDGET CONTROLS
$control_ops = array('width' => 320, 'height' => 350, 'id_base' => 'adverts-234-widget');

// CREATES THE WIDGET
$this->WP_Widget('adverts-234-widget', __('234x60 Advertisements'), $widget_ops, $control_ops ); }
