...
/*
 *
 *	Plugin Name: 250x250 Advertisement Widget
 *	Description: An advanced widget that allows you to display up to four 250x250 advertisements.
 *	Author: Matt Adams
...
add_action('widgets_init', 'advertise_250_load_widgets');

// REGISTER THE WIDGET
function advertise_250_load_widgets() {
	register_widget('Advertise_250_Widget');
}

// THIS CLASS HANDLES EVERYTHING THAT NEEDS TO BE HANDLED BY THE WIDGET
class Advertise_250_Widget extends WP_Widget {

// WIDGET SETUP
function Advertise_250_Widget() {

// WIDGET SETTINGS
$widget_ops = array('classname' => 'adverts-250', 'description' => __('An advanced widget that allows you to display up to four 250x250 advertisements.') );

// WIDGET CONTROLS
$control_ops = array('width' => 320, 'height' => 350, 'id_base' => 'adverts-250-widget' );

// CREATES THE WIDGET
$this->WP_Widget('adverts-250-widget', __('250x250 Advertisements'), $widget_ops, $control_ops ); }
...
if ( $advertiseurl )
	printf( __('<div class="advertise-url"><a href="'.$advertiseurl.'">Advertise Here</a></div>', 'advertise') );
