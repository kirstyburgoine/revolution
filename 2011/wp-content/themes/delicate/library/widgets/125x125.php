...
/*
 *
 *	Plugin Name: 125x125 Advertisement Widget
 *	Description: An advanced widget that allows you to display up to four 125x125 advertisements.
 *	Author: Matt Adams
...
add_action('widgets_init', 'advertise_125_load_widgets');

// REGISTER THE WIDGET
function advertise_125_load_widgets() {
	register_widget('Advertise_125_Widget');
}

// THIS CLASS HANDLES EVERYTHING THAT NEEDS TO BE HANDLED BY THE WIDGET
class Advertise_125_Widget extends WP_Widget {

// WIDGET SETUP
function Advertise_125_Widget() {

// WIDGET SETTINGS
$widget_ops = array('classname' => 'adverts-125', 'description' => __('An advanced widget that allows you to display up to four 125x125 advertisements.') );

// WIDGET CONTROLS
$control_ops = array('width' => 320, 'height' => 350, 'id_base' => 'adverts-125-widget');

// CREATES THE WIDGET
$this->WP_Widget('adverts-125-widget', __('125x125 Advertisements'), $widget_ops, $control_ops ); }
